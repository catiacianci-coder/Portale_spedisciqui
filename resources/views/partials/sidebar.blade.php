    ...
    <nav class="sq-sidebar-nav">
        ...
        <div class="sq-sidebar-section">
            ...
            <ul class="sq-sidebar-list">
                ...
                <li class="sq-sidebar-item"><a href="{{ route('resi.index') }}" class="sq-sidebar-link"><i class="fa-solid fa-rotate-left sq-sidebar-ico sq-sidebar-ico--brand"></i> Gestione resi</a></li>
                <li class="sq-sidebar-item"><a href="{{ route('rimborso-etichette.index') }}" class="sq-sidebar-link @if(request()->routeIs('rimborso-etichette.*')) sq-sidebar-link--active @endif"><i class="fa-solid fa-rotate-left sq-sidebar-ico sq-sidebar-ico--brand"></i> Richiedi rimborso</a></li>
                <li class="sq-sidebar-item"><a href="#" class="sq-sidebar-link"><i class="fa-solid fa-location-dot sq-sidebar-ico sq-sidebar-ico--brand"></i> Tracking</a></li>
        ...
        <div class="sq-sidebar-section">
            ...
            <ul class="sq-sidebar-list">
                <li class="sq-sidebar-item"><a href="{{ route('etichette.index') }}" class="sq-sidebar-link @if(request()->routeIs('etichette.*')) sq-sidebar-link--active @endif"><i class="fa-solid fa-tag sq-sidebar-ico sq-sidebar-ico--spedizioni"></i> Etichette</a></li>
        ...
        <div class="sq-sidebar-section">
            ...
            <ul class="sq-sidebar-list">
                <li class="sq-sidebar-item"><a href="#" class="sq-sidebar-link"><i class="fa-solid fa-file-invoice sq-sidebar-ico sq-sidebar-ico--fin"></i> Fatture</a></li>
