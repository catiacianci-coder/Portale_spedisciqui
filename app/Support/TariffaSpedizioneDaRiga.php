...
final class TariffaSpedizioneDaRiga
{
    ...
    public static function attributiDaRigaCarrello(
        ...
        $totaleClienteTrasportoWallet = round(
            (float) ($it['trasporto_wallet_iva_esc'] ?? CarrelloPrezziWallet::trasportoWalletDaStandard($totaleClienteTrasporto)),
            2,
        );
        $ricaricoTrasporto = round(max(0, $totaleClienteTrasporto - $costoTrasporto - $costoFuel), 2);
